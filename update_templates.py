...
OLD_PATTERNS = [
    (
        ...
        '<!-- Local Tailwind CSS -->\n  <link rel="stylesheet" href="{% static \'pandesal/dist/output.css\' %}" />'
    ),
    (
        r'<link rel="stylesheet" href="https://cdnjs\.cloudflare\.com/ajax/libs/font-awesome/[\d.]+/css/all\.min\.css"\s*/?>',
        '<!-- Icon Libraries with CDN fallback -->\n  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" onerror="this.onerror=null;this.href=\'{% static \'pandesal/css/icons-fallback.css\' %}\';\" />'
    ),
    (
        r'<link rel="stylesheet" href="https://cdn\.jsdelivr\.net/npm/bootstrap-icons@[\d.]+/font/bootstrap-icons\.(?:min\.)?css"\s*/?>',
        '<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css" onerror="this.onerror=null;this.href=\'{% static \'pandesal/css/icons-fallback.css\' %}\';\">'
    ),
]
