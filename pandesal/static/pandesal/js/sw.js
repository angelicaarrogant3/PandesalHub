// Service Worker for PandesalHub PWA
const CACHE_NAME = 'pandesalhub-v3';
const urlsToCache = [
  '/',
  '/static/pandesal/style.css',
  '/static/pandesal/img/pandesalhub_icon.png',
  '/static/pandesal/img/poster.png',
