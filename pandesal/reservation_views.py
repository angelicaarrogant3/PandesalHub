...
def submit_reservation(request):
    ...
    try:
        with transaction.atomic():
            ...
            success_message = '✅ Reservation submitted successfully! Please wait for PandesalHub to confirm your reservation before proceeding to payment.'
...
def reservation_payment(request, reservation_id):
    ...
    return render(request, 'pandesal/reservation_payment.html', context)
...
def reservation_checkout(request):
    ...
    return render(request, 'pandesal/reservation_checkout.html', context)
...
def reservation_create(request, product_id):
    ...
    return render(request, 'pandesal/reservation_form.html', context)
...
def my_reservations(request):
    ...
    return render(request, 'pandesal/my_reservations.html', context)
